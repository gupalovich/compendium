...
class TestConstantsTestCase(TestCase):
    ...
    def test_constants(self):
        self.assertEqual(HEX_KEY_TYPES, self.HEX_KEY_TYPES)
        self.assertEqual(HEX_MOUSE_KEYS, self.HEX_MOUSE_KEYS)
        self.assertEqual(HEX_DIRECT_KEYS, self.HEX_DIRECT_KEYS)
        self.assertEqual(HEX_VIRTUAL_KEYS, self.HEX_VIRTUAL_KEYS)
